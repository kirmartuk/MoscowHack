...
Revision ID: 6c7c8b48c747
Revises: 65ec3b4b35b5
Create Date: 2020-10-31 18:09:47.932217
...
revision = '6c7c8b48c747'
down_revision = '65ec3b4b35b5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('doc', sa.String(length=511), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('submission', sa.String(length=127), nullable=True),
    ...
    op.create_index(op.f('ix_shelter_submission'), 'shelter', ['submission'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_shelter_submission'), table_name='shelter')
